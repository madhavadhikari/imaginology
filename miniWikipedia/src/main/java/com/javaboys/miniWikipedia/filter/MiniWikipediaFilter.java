package com.javaboys.miniWikipedia.filter;
...
import com.javaboys.miniWikipedia.utilities.StringUtils;

@Component
public class MiniWikipediaFilter implements Filter {
	private static final Logger LOG = LoggerFactory.getLogger(MiniWikipediaFilter.class);
